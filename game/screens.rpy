...
init -501 screen phone_message(who, what):
...
init -501 screen phone_message2(who, what):
    vbox at incoming_message:
        style_group "phone_message"
        xoffset -584
        xalign 1.0
...
init -501 screen phone_message3(what):
    vbox at incoming_message:
        style_group "phone_message"
        xoffset -584
        xalign 1.0
...
init -501 screen phone_reply(reply1, label1, reply2, label2):
    modal True
    vbox:
        xalign 0.5
        yalign 0.8
...
init -501 screen phone_reply3(reply1, label1, reply2, label2, reply3, label3):
    modal True
    vbox:
        xalign 0.5
        yalign 0.8
...
init -1 style phone_reply_text:
    xalign 0.5

init -501 screen phone_message_image(who, what, img):
    vbox at incoming_message:
        style_group "phone_message"
